...
class CoinFlip4p extends StatefulWidget {
  const CoinFlip4p({Key? key, this.devModeOn}) : super(key: key);
  final devModeOn;
...
class CoinFlipState extends State<CoinFlip4p> {
