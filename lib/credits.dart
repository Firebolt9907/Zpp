...
class Credits extends StatelessWidget {
  const Credits({super.key, this.darkDynamic, this.lightDynamic, this.topPadding});
                          ...
                          child: ListView(children: [
                            ...
                            Padding(
                                padding: const EdgeInsets.only(
                                    top: 50, bottom: 50, left: 5),
                                child: Hero(
                                    transitionOnUserGestures: true,
                                    tag: 'bolt',
                                    child: Image.asset('assets/bolt.png'))),
                            Padding(
                                        ...
                                        child: AnimatedTextKit(
                                          ...
                                          animatedTexts: [
                                            ColorizeAnimatedText(
                                              ...
                                              textStyle: colorizeTextStyleBig,
                            ...
                            Padding(
                                padding:
                                    const EdgeInsets.only(bottom: 38, left: 5),
                                child: Align(
                                    alignment: Alignment.topLeft,
                                    child: Bounceable(
                                        onTap: () {},
                            ...
                            Padding(
                                ...
                                child: SizedBox(
                                    ...
                                    child: Bounceable(
                                        ...
                                        child: CupertinoButton.filled(
                                          padding: EdgeInsets.zero,
                                          child: Text('iconforest_arcticons',
                                              style: TextStyle(
                                                  fontSize: 20,
                                                  color: context.isDarkMode
                                                      ? Colors.black
